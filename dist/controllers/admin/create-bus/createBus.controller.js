...
export const createBusController = async (request, response) => {
    try {
        const receivedData = request.body;
        console.log("Create bus request received");
        await busesDataModel.create({
            name: "Night Shuttle 101",
            description: "A late-night shuttle service for airport and hotel transfers.",
            capacity: 20,
...
//# sourceMappingURL=createBus.controller.js.map